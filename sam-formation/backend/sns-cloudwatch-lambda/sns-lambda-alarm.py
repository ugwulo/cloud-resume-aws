...
slack_url = os.environ['SLACK_ENDPOINT_URL']
http = urllib3.PoolManager()

# Function to push cloudwatch alarms to slack using our API gateway metrics for number of counts in a minute.
# API gateway pushes logs to Cloudwatch alarm, then use alarm to create an sns topic and push to lambda and onward to slack endpoint.
